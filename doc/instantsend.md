...
This mechanism has been integrated into Bitcore-Node-Community which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/communitypay/insight-api-community#web-socket-api](https://github.com/communitypay/insight-api-community#web-socket-api)
* API: [https://github.com/communitypay/insight-api-community#instantsend-transactions](https://github.com/communitypay/insight-api-community#instantsend-transactions)
...
By default, the Community Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Community Core daemon:
