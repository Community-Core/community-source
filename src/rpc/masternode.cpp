...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_1000000);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Community address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "community",               "masternode",             &masternode,             true,  {} },
    { "community",               "masternodelist",         &masternodelist,         true,  {} },
    { "community",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "community",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "community",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "community",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
