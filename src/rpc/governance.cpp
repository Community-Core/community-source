...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in community.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("community.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Community features */
    { "community",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "community",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "community",               "gobject",                &gobject,                true,  {} },
    { "community",               "voteraw",                &voteraw,                true,  {} },
