    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  community-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Community in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CMT, 0.1 CMT, 1 CMT and 10 CMT -- sort of like the paper money you use every day.</li> \
