    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CMT-light"), QVariant("light"));
    ui->theme->addItem(QString("CMT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CMT-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("CMT-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("CMT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CMT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CMT-traditional"), QVariant("trad"));
