...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid community address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid community address" in e.error['message'])
